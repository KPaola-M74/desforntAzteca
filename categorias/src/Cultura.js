...
export default function Cultura()
{
    ...
    return (
        <div className="sketchfab-embed-wrapper">
            ...
            <iframe style={{width: '40%', height: '400px'}} title="Cultura" frameBorder="0" allowFullScreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport execution-while-not-rendered web-share src="https://sketchfab.com/models/3be2b0a37a6d40e8860b7bff46c94179/embed"></iframe>
